...
在你选择的实验的基础上，完成进阶版其中部分或全部的要求，并写作一篇6~8页左右的论文作为实验报告上交。

* 论文模板为latex模板，在这个链接给出[计算机学会格式论文模板-校内下载链接](http://172.18.233.211:5244/directlink/VLSI/VLSI课程/dataset/VLSI课程大作业模板.zip)。
...
<mark>论文长度要求</mark>：例如在第6页第二列文字超过中线的一半才算论文有第6页。<br>
...
大作业上交时一同上交小作业的代码，每份代码用一个单独的文件夹存放。然后压缩成"学号-姓名-大作业.zip"文件夹上交。
